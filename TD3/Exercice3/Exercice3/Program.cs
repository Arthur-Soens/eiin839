...
namespace Exercice3
{
    ...
    class Client
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            HttpResponseMessage response = await clientSocket.GetAsync("https://api.jcdecaux.com/vls/v3/stations/"+args[1]+"?contract=" + args[0] + "&apiKey=2ba463e0d63cedfd5374762396b92c89cd41ec62");
            string responseBody = await response.Content.ReadAsStringAsync();
            Station stationT = JsonSerializer.Deserialize<Station>(responseBody);
            Console.WriteLine(stationT.toString());         
